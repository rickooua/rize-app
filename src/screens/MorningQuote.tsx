  ...
  return (
    ...
    >
      <motion.button
        ...
        className="group relative flex min-h-[min(72vh,520px)] w-full flex-col items-stretch overflow-hidden rounded-[28px] border border-white/[0.06] bg-gradient-to-br from-[#141528] via-[#0c0d18] to-[#06070f] p-8 text-left shadow-[0_24px_80px_-20px_rgba(0,0,0,0.65)] touch-manipulation"
      >
        ...
        <p className="relative mt-8 text-center text-sm text-rize-muted/90">
